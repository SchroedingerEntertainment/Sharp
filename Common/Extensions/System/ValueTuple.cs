...
namespace System
{
        ...
        : IEquatable<ValueTuple>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple>, ITupleInternal
    {
        ...
        int IComparable.CompareTo(object other)
        {
            ...
            {
                throw new ArgumentException(ErrorCodes.ValueTupleIncorrectType, "other");
            }
        ...
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3, int h4)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Add(h4).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Add(h4).Add(h5).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Add(h4).Add(h5).Add(h6).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6, int h7)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Add(h4).Add(h5).Add(h6).Add(h7).Value;
        }

        internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6, int h7, int h8)
        {
            return HashCombiner.Initialize().Add(h1).Add(h2).Add(h3).Add(h4).Add(h5).Add(h6).Add(h7).Add(h8).Value;
        }
    }
        ...
        : IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ", " + Item5.ToStringNoExcept() + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ", " + Item5.ToStringNoExcept() + ", " + Item6.ToStringNoExcept() + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, ITupleInternal
    {
        ...
        public override string ToString()
        {
            return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ", " + Item5.ToStringNoExcept() + ", " + Item6.ToStringNoExcept() + ", " + Item7.ToStringNoExcept() + ")";
        }
        ...
        where TRest : struct
    {
        ...
        public ValueTuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, TRest rest)
        {
            ...
            {
                throw new ArgumentException(ErrorCodes.ValueTupleLastArgumentNotAValueTuple);
            }
        ...
        public override string ToString()
        {
            ...
            if (rest == null)
            {
                return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ", " + Item5.ToStringNoExcept() + ", " + Item6.ToStringNoExcept() + ", " + Item7.ToStringNoExcept() + ", " + Rest.ToString() + ")";
            }
            else
            {
                return "(" + Item1.ToStringNoExcept() + ", " + Item2.ToStringNoExcept() + ", " + Item3.ToStringNoExcept() + ", " + Item4.ToStringNoExcept() + ", " + Item5.ToStringNoExcept() + ", " + Item6.ToStringNoExcept() + ", " + Item7.ToStringNoExcept() + ", " + rest.ToStringEnd();
            }
        }
