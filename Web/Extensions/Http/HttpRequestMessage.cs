    ...
    public class HttpRequestMessage : IDisposable
    {
        ...
        public Uri RequestUri
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(ErrorCodes.NetHttpClientHttpBaseaddressRequired, "value");
                }
                CheckDisposed();
        ...
        private void InitializeValues(HttpMethod method, Uri requestUri)
        {
            ...
            {
                throw new ArgumentException(ErrorCodes.NetHttpClientHttpBaseaddressRequired, "requestUri");
            }
