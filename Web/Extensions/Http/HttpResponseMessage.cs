    ...
    public class HttpResponseMessage : IDisposable
    {
        ...
        public HttpContent Content
        {
            ...
            set 
            {
                ...
                if (Logging.On)
                {
                    if (value == null)
                    {
                        Logging.PrintInfo(Logging.Http, this, ErrorCodes.NetHttpLogContentNull);
                    }
                    else
                    {
        ...
        public string ReasonPhrase
        {
            ...
            set
            {
                ...
                {
                    throw new FormatException(ErrorCodes.NetHttpReasonphraseFormatError);
                }
                CheckDisposed();
        ...
        public HttpResponseMessage EnsureSuccessStatusCode()
        {
            if (!IsSuccessStatusCode)
            {
                ...
                throw new HttpRequestException(string.Format(System.Globalization.CultureInfo.InvariantCulture, ErrorCodes.NetHttpMessageNotSuccessStatuscode, (int)statusCode,
                    ReasonPhrase));
            }
            return this;
        }
