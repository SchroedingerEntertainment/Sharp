...
namespace System.Net.Http.Headers
{
    public class ViaHeaderValue : ICloneable
    {
        ...
        private static void CheckReceivedBy(string receivedBy)
        {
            ...
            {
                throw new ArgumentException(ErrorCodes.NetHttpArgumentEmptyString, "receivedBy");
            }
            ...
            {
                throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, ErrorCodes.NetHttpHeadersInvalidValue, receivedBy));
            }
        }
    }
}
