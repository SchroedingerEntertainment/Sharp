...
namespace System.Net.Http.Headers
{
    ...
    internal class ByteArrayHeaderParser : HttpHeaderParser
    {
        ...
        public override bool TryParseValue(string value, object storeValue, ref int index, out object parsedValue)
        {
            ...
            {
                if (Logging.On) Logging.PrintError(Logging.Http, string.Format(System.Globalization.CultureInfo.InvariantCulture, ErrorCodes.NetHttpParserInvalidBase64String, base64String, e.Message));
            }
