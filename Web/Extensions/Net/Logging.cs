...
namespace System.Net.Http
{
    ...
    internal class Logging
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1060:MovePInvokesToNativeMethodsClass", Justification = "code is clone of System.Net.Http")]
        ...
        internal static void Exception(TraceSource traceSource, object obj, string method, Exception e)
        {
            ...
            string infoLine = string.Format(CultureInfo.InvariantCulture, ErrorCodes.NetLogException, GetObjectLogHash(obj), method, exceptionMessageBuilder.ToString());
